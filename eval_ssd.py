...
import logging
import sys
from vision.ssd.efficientnet_ssd import create_efficientnet, create_efficientnet_predictor


parser = argparse.ArgumentParser(description="SSD Evaluation on VOC Dataset.")
parser.add_argument('--net', default="efficientnet",
...
if __name__ == '__main__':
    ...
    if args.net == 'vgg16-ssd':
        ...
        net = create_efficientnet(len(class_names), is_test=True)
    else:
    ...
    if args.net == 'vgg16-ssd':
        ...
        predictor = create_efficientnet_predictor(net,nms_method=args.nms_method, device=DEVICE)
    else:
        logging.fatal("The net type is wrong. It should be one of vgg16-ssd, mb1-ssd and mb1-ssd-lite.")
        parser.print_help(sys.stderr)
        sys.exit(1)
