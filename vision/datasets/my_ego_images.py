...
labels= ['background','Handgun','Shotgun']

if __name__ == '__main__':
    dataset_path='/media/mostafa/RESEARCH/EPIC_KITCHENS_2018/detection_code/pytorch-ssd/data/open_images/'
    dataset = OpenImagesDataset(dataset_path, dataset_type="train")
