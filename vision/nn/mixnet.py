...
class MixNet(nn.Module):
    ...
    def __init__(self, net_type='mixnet_l', input_size=224, num_classes=1000, stem_channels=16, feature_size=1536, depth_multiplier=1.0):
        ...
        self.layers = nn.Sequential(Conv3x3Bn(3, stem_channels, 2),(*layers),Conv1x1Bn(config[-1][1], feature_size))
...
# class MixNetWrapper(nn.Module):
#     def __init__(self, num_classes=101): 

#         super(MixNetWrapper, self).__init__()

#         self.mixnet = MixNet()

#         del self.mixnet.classifier
