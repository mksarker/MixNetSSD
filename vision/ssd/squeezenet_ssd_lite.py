...
def create_squeezenet_ssd_lite(num_classes, is_test=False):
    base_net = squeezenet1_1(pretrained=True).features  # disable dropout layer
    # print(base_net)
...
def create_squeezenet_ssd_lite_predictor(net, candidate_size=200, nms_method=None, sigma=0.5, device=torch.device('cuda:0')):
